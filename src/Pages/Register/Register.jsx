...
const Register = () => {
    ...
    const handleRegister = e => {
        ...
        console.log(name, email, password, idNum)
        ...
        if (idNum.length === 10 || idNum.length === 16) {
            ...
            return swal("দুঃখিত!", "id কার্ডের নাম্বার ১০ সংখ্যা অথবা ১৬ সংখ্যা হতে হবে!", "error");
        }
            ...
            <div className="">
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center justify-between min-h-[96vh] ">
                    ...
                    <div className="flex-1">
                        ...
                        <form onSubmit={handleRegister} className="relative flex flex-col text-gray-900 shadow-md w-full md:w-96 loginRegister rounded-xl bg-clip-border mx-auto mt-16 lg:mt-0">
                            <div
